...
class BeforePage extends StatefulWidget {
  @override
  _BeforePage createState() => _BeforePage();
}

class _BeforePage extends State<BeforePage> {
  File _image, _image2;
